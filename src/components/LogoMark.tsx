// Viventia Dual Pillar V — exact SVG paths from brand asset
...
export default function LogoMark({ size = 40, color = "#D8B56A", className = "" }: LogoMarkProps) {
  return (
    <svg
